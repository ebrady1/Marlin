...
//  #define HOTEND_IDLE_MIN_TRIGGER   180     // (°C) Minimum temperature to enable hotend protection
  #define HOTEND_IDLE_MIN_TRIGGER   55        // (°C) Minimum temperature to enable hotend protection
...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.04925    // Unit: mm compression per 1mm/s extruder speed
 ...
 */
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V  //#define CHOPPER_TIMING CHOPPER_DEFAULT_12V        // All axes (override below)
